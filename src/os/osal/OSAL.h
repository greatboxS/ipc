 ...
 *
 */
#ifndef __OSALTYPE_H__
#define __OSALTYPE_H__
...
/* ------------------------------ SECURED SHARE MEMORY -------------------------- */
typedef struct __SecuredShareMemory_t {
    char name[SHM_NAME_SIZE + 10];
    int32_t isopen;
    MUTEX_T mtx;
    SEM_T sem;
    SHM_T shm;
} SecuredShareMemory_t;

#define SECURED_SHARE_MEMORY_T SecuredShareMemory_t
/* ------------------------------ SECURED SHARE MEMORY -------------------------- */
