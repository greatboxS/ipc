    ...
    namespace osal
    {
        ...
        int SOCKET_Close(SOCKET_T &sk) {
            ...
            if (closesocket(sk.skHandle) < 0) {
                ...
                LOG_OSAL_ERROR("[%s] Close socket failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_Connect(SOCKET_T &sk, const char *remoteip, uint16_t remoteport) {
            ...
            if (connect(sk.skHandle, (sockaddr *)socketaddr, size) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Socket connect error, %d\n", sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_Disconnect(SOCKET_T &sk) {
            if (shutdown(sk.skHandle, SD_BOTH) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Shutdown failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_Listen(SOCKET_T &sk, uint32_t connection) {
            ...
            if (listen(sk.skHandle, connection) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Listen failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_Bind(SOCKET_T &sk, uint16_t port) {
            ...
            if (bind(sk.skHandle, (sockaddr *)socketaddr, size) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Bind failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
        ...
        SOCKET_T SOCKET_Accept(SOCKET_T &sk) {
            ...
            if ((stSocket.skHandle = accept(sk.skHandle, (sockaddr *)&stSocket.stAddrInet.Ip,
                                            (socklen_t *)&stSocket.stAddrInet.u32Size)) == INVALID_SOCKET) {
                stSocket.skHandle = 0;
                stSocket.s32Error = __ERROR__;
                // LOG_OSAL_ERROR("[%s] Accept failed, %d\n", __FUNCTION__, sk.s32Error);
            }
        ...
        int SOCKET_Send(SOCKET_T &sk, const char *buff, size_t size) {
            ...
            if ((bytes = send(sk.skHandle, buff, size, 0)) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Send failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return bytes;
        }
        ...
        int SOCKET_Recv(SOCKET_T &sk, char *buff, size_t size) {
            ...
            if ((bytes = recv(sk.skHandle, buff, size, 0)) < 0) {
                sk.s32Error = __ERROR__;
                // LOG_OSAL_ERROR("[%s] Receive failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return bytes;
        }
        ...
        int SOCKET_SendTo(SOCKET_T &sk, SOCKADDR_T &sendaddr, const char *buff, size_t size) {
            ...
            if ((bytes = sendto(sk.skHandle, buff, size, 0, (sockaddr *)&sendaddr, addrSize)) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Send to failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return bytes;
        }
        ...
        int SOCKET_SendMulticast(SOCKET_T &sk, const char *groupip, uint16_t port, const char *buff, size_t size) {
            ...
            if (setsockopt(sk.skHandle, IPPROTO_IP, IP_MULTICAST_LOOP, (char *)&loopch, sizeof(loopch)) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAC_ERROR("[%s] setting IP_MULTICAST_LOOP: failed, %d", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            /*
            ...
            if (setsockopt(sk.skHandle, IPPROTO_IP, IP_MULTICAST_IF, (char *)&sk.stAddrInet.Ip.v4, sizeof(sk.stAddrInet.Ip.v4)) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAC_ERROR("[%s] Setting local interface for multicast failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            ...
            if (sendto(sk.skHandle, buff, size, 0, (struct sockaddr *)&stGroupSocket, sizeof(stGroupSocket)) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAC_ERROR("[%s] Sending datagram message failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_SetRecvBuffer(SOCKET_T &sk, uint32_t size) {
            ...
            if (setsockopt(sk.skHandle, SOL_SOCKET, SO_RCVBUF, (char *)&s32Size, len) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Set buffer failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_SetRecvTimeout(SOCKET_T &sk, uint32_t ms) {
            ...
            if (setsockopt(sk.skHandle, SOL_SOCKET, SO_RCVTIMEO, (char *)&pstTime, len) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Set receiving timeout %d failed, %d\n", __FUNCTION__, ms, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
        ...
        int SOCKET_SetBlockingMode(SOCKET_T &sk, int32_t mode) {
            ...
            if (ioctlsocket(sk.skHandle, FIONBIO, &iMode) < 0) {
                sk.s32Error = __ERROR__;
                LOG_OSAL_ERROR("[%s] Set blocking mode failed, %d\n", __FUNCTION__, sk.s32Error);
                return RET_ERR;
            }
            return RET_OK;
        }
